...
|                                  Description                                 |
+==============================================================================+
| CPocker: an poker game agianst the machine.                                  |
|                                                                              |
| By Start CPoker display an welcome screen with an little animation, in which |
| you can choose the number of rounds you want to play against the machine     |
| 20 per default.                                                              |
| You can increase the value with the ARROW UP and decrease it with the ARROW  |
| DOWN.                                                                        |
| Once you have selected the number of rounds you want to play, you can press  |
| the Return key to start the game.                                            |
|                                                                              |
| By game start there only an stack of card displayed and you must press the   |
...
| the mouse over an card to return it an discover what cards you get.          |
|                                                                              |
...
| order it as you like, even move it into an emtpy frame. To get a better      |
| view of your hand.                                                           |
|                                                                              |
...
| button. And the programme will compute the round winner, display an blinking |
...
|     Heart, Spade, Club).                                                     |
|     if the two players get an ROYAL QUINTE FLUSH there is an egality.        |
|     No color have precedence on another.                                     |
|                                                                              |
|  2) QUINTE FLUSH                                                             |
|     5 following cards values not ending with an Ace from the same color      |
|     (Diamond , Heart, Spade, Club).                                          |
|     if the two players get an QUINTE FLUSH the highest card decide which is  |
...
|     in an 32 cards game (from 7 to Ace). CPocker use a 32 cards game.        |
|                                                                              |
|  4) FULL HOUSE                                                               |
|     3 same cards from the same value (an BRELAN) and 2 same cards from the   |
|     same value (an PAIR).                                                    |
|     Egality is not possible with an 32 cards games, because for comparing    |
|     2 FULL HOUSE we must compare the BRELAN values which cannot be the same  |
|     in an 32 cards game (from 7 to Ace).                                     |
|                                                                              |
|  5) COLOR                                                                    |
...
|     If the two players get an brelan the highest BRELAN decide which is the  |
|     winner.                                                                  |
|     It's impossible that the two players get the same BRELAN at the same     |
|     time in an 32 cards game (from 7 to Ace).                                |
|                                                                              |
|  8) TWO PAIRS                                                                |
